                     ...
                     btas::QSDArray<3>& mps0, int M)
{
  if(forward) {
    ...
    btas::QSDArray<2> v;
    btas::QSDgesvd(btas::LeftCanonical,  wfn0, s, mps0, v, M);
  }
  else {
    btas::DiagonalQSDArray<1> s;
    btas::QSDArray<2> u;
    btas::QSDgesvd(btas::RightCanonical, wfn0, s, u, mps0, M);
  }
}
                     ...
                     btas::QSDArray<3>& wfn1, int M)
{
  if(forward) {
    btas::DiagonalQSDArray <1> s;
    btas::QSDgesvd(btas::LeftCanonical,  wfnx, s, mps0, wfn1, M);
    btas::SDdidm(s, wfn1);
  }
  else {
    btas::DiagonalQSDArray <1> s;
    btas::QSDgesvd(btas::RightCanonical, wfnx, s, wfn1, mps0, M);
    btas::SDdimd(wfn1, s);
  }
}
