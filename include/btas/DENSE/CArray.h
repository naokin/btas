...
/// Alias to single precision complex slice array
template<size_t N>
using CSlice = TSlice<std::complex<float>, N>;

/// Alias to single precision complex const slice array
template<size_t N>
using CConstSlice = TConstSlice<std::complex<float>, N>;
