...
//template<typename T>
//struct __TensorIteratorConst<typename std::vector<T>::iterator>
...
///// Specialized for a std::vector<T>::iterator
//template<typename T>
//struct __TensorIteratorRemoveConst<typename std::vector<T>::iterator>
//{ typedef typename std::vector<T>::iterator type; };

///// Specialized for a std::vector<T>::iterator
//template<typename T>
//struct __TensorIteratorRemoveConst<typename std::vector<T>::const_iterator>
//{ typedef typename std::vector<T>::iterator type; };
