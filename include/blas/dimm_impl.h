#ifndef __BTAS_BLAS_DIMM_IMPL_H
#define __BTAS_BLAS_DIMM_IMPL_H 1
...
#pragma omp for schedule(static) nowait
      ...
      {
         BTAS_BLAS_ASSERT(false, "dimm: unknown options for transA and/or transB");
      }
   }
